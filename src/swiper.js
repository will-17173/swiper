...
define(function(require, exports, module) {
    ...
    (function() {
        ...
        Swiper
        ===========================*/
        Swiper = window.Swiper = function(container, params) {
            ...
            if (s.rtl) {
                s.container.addClass('swiper-container-rtl');
            }
            ...
            s.preloadImages = function() {
                ...
                function _onReady() {
                    ...
                    if (s.imagesLoaded === s.imagesToLoad.length) {
                        ...
                        if (s.params.onImagesReady) {
                            s.params.onImagesReady(s);
                        }
                    }
                }
            ...
            s.startAutoplay = function() {
                ...
                s.autoplaying = true;
                if (s.params.onAutoplayStart) {
                    s.params.onAutoplayStart(s);
                }
                autoplay();
            };
            s.stopAutoplay = function(internal) {
                ...
                s.autoplaying = false;
                s.autoplayTimeoutId = undefined;
                if (s.params.onAutoplayStop) {
                    s.params.onAutoplayStop(s);
                }
            };
                ...
                if (s.params.slidesPerColumn > 1) {
                    ...
                    if (s.params.centeredSlides) {
                        ...
                        for (i = 0; i < s.snapGrid.length; i++) {
                            if (s.snapGrid[i] < s.virtualWidth + s.snapGrid[0]) {
            ...
            s.updateProgress = function(translate) {
                ...
                if (s.isBeginning && s.params.onReachBeginning){
                    s.params.onReachBeginning(s);
                } 
                if (s.isEnd && s.params.onReachEnd){
                    s.params.onReachEnd(s);
                } 

                if (s.params.watchSlidesProgress) {
                    s.updateSlidesProgress(translate);
                }
                if (s.params.onProgress){
                    s.params.onProgress(s, s.progress);
                }
            };
            ...
            s.onTouchStart = function(e) {
                ...
                if (s.params.onTouchStart) {
                    s.params.onTouchStart(s, e);
                }
            };
            ...
            s.onTouchMove = function(e) {
                ...
                if (s.params.onTouchMove) {
                    s.params.onTouchMove(s, e);
                }
                s.allowClick = false;
                ...
                if (s.params.onSliderMove) {
                    s.params.onSliderMove(s, e);
                }
            ...
            s.onTouchEnd = function(e) {
                ...
                if (s.params.onTouchEnd){
                    s.params.onTouchEnd(s, e);
                } 
                if (!isTouched) {
                    return;
                }
                    ...
                    if (s.params.freeModeMomentum) {
                        ...
                        if (s.params.freeModeMomentumBounce && doBounce) {
                            ...
                            s.wrapper.transitionEnd(function() {
                                ...
                                if (s.params.onMomentumBounce) {
                                    s.params.onMomentumBounce(s);
                                }
            ...
            s.onTransitionStart = function(runCallbacks) {
                ...
                if (runCallbacks) {
                    if (s.params.onTransitionStart) {
                        s.params.onTransitionStart(s);
                    }
                    if (s.params.onSlideChangeStart && s.activeIndex !== s.previousIndex){
                        s.params.onSlideChangeStart(s);
                    } 
                }
            };
            s.onTransitionEnd = function(runCallbacks) {
                ...
                if (runCallbacks) {
                    if (s.params.onTransitionEnd) {
                        s.params.onTransitionEnd(s);
                    }
                    if (s.params.onSlideChangeEnd && s.activeIndex !== s.previousIndex) {
                        s.params.onSlideChangeEnd(s);
                    }
                }
            ...
            s.setWrapperTransition = function(duration, byController) {
                ...
                if (s.params.onSetTransition) {
                    s.params.onSetTransition(s, duration);
                }
            ...
            s.setWrapperTranslate = function(translate, updateActiveIndex, byController) {
                ...
                if (s.params.onSetTranslate) {
                    s.params.onSetTranslate(s, s.translate);
                }
            };
            ...
            function initObserver(target, options) {
                ...
                var observer = new ObserverFunc(function(mutations) {
                    mutations.forEach(function(mutation) {
                        s.onResize();
                        if (s.params.onObserverUpdate){
                            s.params.onObserverUpdate(s, mutation);
                        } 
                    });
                });
                ...
                load: function() {
                    ...
                    if (s.params.lazyLoadingInPrevNext) {
                        ...
                        if (prevSlide.length > 0){
                            s.loadImageInSlide(prevSlide.index());
                        } 
                    }
                },
